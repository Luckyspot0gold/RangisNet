...
export class AIPhonic LearningSystem {
 ...
 */
export function createAIPhonicSystem(): AIPhonic LearningSystem {
  return new AIPhonic LearningSystem();
}
...
export function predictFromBell(
  ...
  system: AIPhonic LearningSystem,
  asset: string = 'BTC'
): AIPhonicPrediction {
...
export default AIPhonic LearningSystem;
