...
- **[🎯 5-Step Quick Start](docs/whitepaper/5-STEP-QUICKSTART.md)** – Get running in 5 minutes
- **[📖 AEAS v1.1 Standard](docs/aeas/AEAS_V1.1_STANDARD.md)** – The complete technical specification

### Deep Dives
- **[🏗️ Architecture](docs/architecture/)** – Avalanche integration, ICM, market data APIs
- **[🚀 Deployment](docs/deployment/)** – Vercel, Google Cloud, custom hosting
- **[🔐 IP & Legal](docs/ip-and-legal/)** – Licensing, patents, commercial agreements
- **[🎓 AEAS Documentation](docs/aeas/)** – Academic literature, privacy strategy, Venice AI dialogue

### For Builders
- **[🔧 API Keys Setup](docs/whitepaper/API_KEYS_SETUP.md)** – Configure external services
- **[📡 Avalanche Integration](docs/architecture/AVALANCHE-ARCHITECTURE.md)** – C-Chain, subnets, validators
- **[🤝 Partner Integration](docs/whitepaper/PARTNERS_INTEGRATION.md)** – Pyth, LayerZero, Thirdweb
...
[Full IP documentation →](docs/ip-and-legal/)
...
[Read the full philosophical dialogue with Venice AI →](docs/aeas/VENICE_AI_CONVERSATION_REFINEMENTS.md)
